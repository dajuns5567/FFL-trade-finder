...
export const REPORTERS=[
 ...
 {id:'nora-voss',name:'Jefferson Filch',title:'Investigations & Front Office',desk:'The Inquiry Desk',voice:'Hometown investigative columnist, suspicious fan and professional grudge archivist. Case-file construction, noir sarcasm, petty precision, lineup and transaction memory, and a habit of carrying unresolved questions into the next week. He remembers how players arrived, what management gave up and whether the same mistake has appeared before.',signature:'Every lineup leaves fingerprints.'}
];
