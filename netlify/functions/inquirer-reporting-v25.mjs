...
function teamPlayerExtraV33(t,r,f,slot){
  ...
  const banks=[
    ...
    [
      ...
      [team+' is '+rec+', and Bartholomew refuses to let one handsome player line redecorate the standings. Praise the player; leave the record where everyone can see it.','The '+team+' record reads '+rec+'. One elegant individual performance is not large enough to drape over that entire piece of furniture.',team+' carries a '+rec+' record into the next column. Bartholomew can compliment the player page without pretending the standings suddenly acquired better taste.','At '+rec+', '+team+' still has larger concerns than one player can solve alone. Bartholomew will keep the praise narrow and the team judgment appropriately impolite.'],
      [team+' is '+rec+'. Good player line, same standings. Tilly can hold two thoughts at once, which apparently puts the newsroom ahead of half the group chat.',team+' leaves the week '+rec+'. Credit the player who earned it; do not use him as a tarp for the rest of the roster.',team+' is '+rec+'. The player page has some good news. The standings did not get the memo.','The '+team+' record is '+rec+'. Tilly will praise the right name and keep the team-wide optimism locked until the wins show up.'],
      ['The team-level record remains '+rec+' for '+team+'. Individual affirmative evidence does not alter that standing, and the article should not use it as a substitute for a favorable result.','At '+rec+', '+team+' has separate player and team findings. Filch keeps them separate because strong individual evidence cannot erase an adverse record.','The '+team+' record is '+rec+'. Player-level credit remains admissible, but it does not rebut the standings by itself.','Filch records '+team+' at '+rec+' and leaves the individual praise in its proper scope. The larger team finding requires wins.']
    ],
    [
      ...
      [next+' is next, and Bartholomew would appreciate the useful '+team+' roles arriving intact rather than as charming anecdotes from last Sunday.',team+' gets '+next+' next. The elegant outcome would be the same useful role with fewer of the week’s less attractive accessories.',next+' now gets a turn at the '+team+' player story. Bartholomew wants the role to travel; nostalgia for one Sunday is terribly common and rarely useful.','The next opponent is '+next+'. Bartholomew will judge the useful '+team+' role by whether it survives a new guest list, not by how fondly everyone remembers this week.'],
      [next+' is next. Keep the useful '+team+' role, lose the excuses and give Tilly a reason to write a different joke.',team+' gets '+next+' next. The player who earned ink this week can make it a trend; everybody else can stop volunteering for the wrong headline.',next+' is waiting. Tilly wants the good '+team+' role to travel and the bad one to miss the bus.','The next page says '+next+'. Repeat the useful role, fix the quiet one and spare Tilly another copy-and-paste complaint.'],
