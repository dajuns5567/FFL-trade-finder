...
export default async()=>{
  try{
    ...
    const v114='<script src="/trade-section1-v114.js?v=114"></script><script>window.__section1Release="v114";window.section1V114?.install?.();</script>';
    const html=sourceUi.replace("</body>",scripts+directSection1+v113+v114+"</body>");
    return new Response(html,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"no-store","x-fll-release":"section1-v114"}});
