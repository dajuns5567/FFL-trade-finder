...
export default async()=>{
  try{
    ...
    const v113='<script src="/trade-section1-v113.js?v=113"></script><script>window.__section1Release="v113";window.section1V113?.install?.();</script>';
    const html=sourceUi.replace("</body>",scripts+directSection1+v113+"</body>");
    return new Response(html,{status:200,headers:{"content-type":"text/html; charset=utf-8","cache-control":"no-store","x-fll-release":"section1-v113"}});
