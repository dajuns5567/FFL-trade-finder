...
export default async () => {
  ...
  // Frozen valuation path from V141. V207 keeps V206/V205/V204/V202/V200/V198/V197 valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v207-two-player-two-player-selection-share'
    }
  });
};