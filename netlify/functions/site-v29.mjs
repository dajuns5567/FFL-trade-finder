...
export default async () => {
  ...
  // Frozen valuation path from V141. V187 does not alter player/pick valuation formulas.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v187-value-adjustment-curve'
    }
  });
};
