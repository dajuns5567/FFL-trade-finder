...
export default async () => {
  ...
  // Frozen valuation path from V141. V204 keeps V202/V200/V198/V197 valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v204-direct-v202-max-value-mix'
    }
  });
};
