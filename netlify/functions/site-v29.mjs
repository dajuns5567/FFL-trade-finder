...
export default async () => {
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v262-selected-positions-only'
    }
  });
};
