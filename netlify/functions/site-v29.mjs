...
export default async () => {
  ...
  // V178 preserves all Finder selection logic and enforces fairness-first ordering only on the final blank result array.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v178-array-fairness-order'
    }
  });
};
