...
export default async () => {
  ...
  // Frozen valuation path from V141. V224 keeps the exact V223/V209 Finder logic and V221 Future behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v224-win-now-isolated-on-v223-v221-v209'
    }
  });
};
