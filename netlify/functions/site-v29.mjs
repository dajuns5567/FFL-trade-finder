...
export default async () => {
  ...
  // Frozen valuation path from V141. V219 keeps V209 valuation/fairness/tier logic unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v219-future-reanalysis-on-v209'
    }
  });
};
