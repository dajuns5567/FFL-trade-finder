...
export default async () => {
  ...
  // Frozen valuation path from V141. V218 keeps the exact V209 Finder logic and valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v218-style-specific-preferences-on-v209'
    }
  });
};
