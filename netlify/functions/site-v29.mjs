...
export default async () => {
  ...
  // Frozen valuation path from V141. V201 keeps V200/V198/V197 valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v201-neutral-three-asset-cap-fix'
    }
  });
};
