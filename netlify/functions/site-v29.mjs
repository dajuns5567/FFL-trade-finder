...
export default async () => {
  ...
  raw = raw.replace('</head>', '<link rel="stylesheet" href="/fleeced-theme-v274.css?v=481"></head>');
  ...
  const runtime = '<script>window.__section1Release="v263";</script><script src="/trade-select-all-v165.js?v=439"></script><script src="/trade-blank-cache-v167.js?v=169"></script><script src="/trade-partner-fit-v184.js?v=186"></script><script src="/trade-style-preferences-v221.js?v=221"></script><script src="/trade-win-now-preferences-v226.js?v=226"></script><script src="/pick-display-sync-v279.js?v=279"></script><script src="/trade-specific-blank-router-v325.js?v=439"></script><script src="/trade-specific-max-tier-add-v300.js?v=300"></script><script src="/trade-specific-tier-up-v282.js?v=282"></script><script src="/trade-specific-add-assets-v282.js?v=309"></script><script src="/trade-specific-max-value-v279.js?v=439"></script><script src="/trade-specific-player-v232.js?v=439"></script><script src="/trade-finder-v256-compiled.js?v=448"></script><script src="/trade-evaluator-any-team-v184.js?v=285"></script><script src="/trade-runtime-v256-compiled.js?v=448"></script><script>window.section1V130?.install?.();</script><script src="/trade-selected-positions-only-v262.js?v=262"></script><script src="/trade-finder-candidate-guard-v223.js?v=263"></script><script src="/trade-ui-canonical-v136.js?v=141"></script><script src="/trade-presentation-v169.js?v=197"></script><script src="/trade-recommended-pick-ownership-v301.js?v=301"></script><script src="/methodology-v264.js?v=264"></script><script src="/value-history-v276.js?v=478" defer></script><script src="/value-history-ui-defaults-v386.js?v=386" defer></script><script src="/fleeced-presentation-v413.js?v=438" defer></script><script src="/fleeced-home-v424.js?v=480" defer></script><script src="/league-hub-v451.js?v=486"></script><script>(function(){function recoverLeagueHub(){var b=document.querySelector(".tabs button[data-tab=\"leagueHub\"]"),s=document.getElementById("leagueHub");if(b&&s&&s.querySelector("#leagueHubContent"))return;var old=document.getElementById("leagueHubRecoveryScript");if(old)return;var x=document.createElement("script");x.id="leagueHubRecoveryScript";x.src="/league-hub-v451.js?v=486-recovery";x.onload=function(){var btn=document.querySelector(".tabs button[data-tab=\"leagueHub\"]");if(btn&&btn.classList.contains("active"))btn.click()};document.head.appendChild(x)}setTimeout(recoverLeagueHub,250);setTimeout(recoverLeagueHub,1200)})();</script>';
