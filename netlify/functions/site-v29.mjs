...
export default async () => {
  ...
  // Frozen valuation path from V141. V254 changes only manual Add assets if needed package input/backfill behavior.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v254-add-assets-internal-backfill'
    }
  });
};
