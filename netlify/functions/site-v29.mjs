...
export default async () => {
  ...
  // Frozen valuation path from V141. V257 only flattens the already-tested V256 Finder/runtime transforms into static files.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v257-flattened-runtime'
    }
  });
};
