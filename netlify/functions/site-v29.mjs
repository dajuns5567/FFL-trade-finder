...
export default async () => {
  ...
  // Frozen valuation path from V141. V255 changes only manual Add assets if needed generation/retention behavior.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v255-add-assets-visible-mix'
    }
  });
};
