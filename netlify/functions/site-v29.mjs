...
export default async () => {
  ...
  // Frozen valuation path from V141. V253 changes only manual Add assets if needed backfill behavior and fails closed to the V250 runtime if a guarded transform cannot be applied.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v253-add-assets-failsafe'
    }
  });
};
