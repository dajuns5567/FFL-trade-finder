...
export default async () => {
  ...
  // Frozen valuation path from V141. V223 keeps the exact V209 Finder logic and V221 Future preference behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v223-finder-guard-fix-on-v221-v209'
    }
  });
};
