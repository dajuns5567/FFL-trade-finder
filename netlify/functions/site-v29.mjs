...
export default async () => {
  ...
  // Frozen valuation path from V141. V200 keeps V198/V197/V196/V195 valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v200-max-value-neutral-safe'
    }
  });
};
