...
export default async () => {
  ...
  // Frozen valuation path from V141. V229 keeps the exact V223/V209 Finder logic and V221/V226 style behavior unchanged when the specific-player filter is off.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v229-specific-player-isolated-on-v228-v223-v221-v209'
    }
  });
};
