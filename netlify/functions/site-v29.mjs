...
export default async () => {
  ...
  // Frozen valuation path from V141. V221 keeps the exact V209 Finder logic and valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v221-future-quality-diversity-on-v209'
    }
  });
};
