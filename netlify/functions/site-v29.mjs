...
export default async () => {
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v263-selected-positions-add-assets-performance-methodology-v264-value-history-v275-theme-v274-load-v275'
    }
  });
};
