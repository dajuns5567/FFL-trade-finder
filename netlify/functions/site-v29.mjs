...
export default async () => {
  ...
  // Frozen valuation path from V141. V256 changes only Add assets if needed search breadth/cadence for performance.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v256-add-assets-performance'
    }
  });
};
