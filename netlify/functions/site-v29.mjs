...
export default async () => {
  ...
  // Frozen valuation path from V141. V220 keeps the exact V209 Finder logic and valuation behavior unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v220-future-preference-on-v209'
    }
  });
};
