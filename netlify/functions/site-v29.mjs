...
export default async () => {
  ...
  // Frozen V141 valuation path remains unchanged. V259 remains installed for legacy/pick behavior.
  // V318 publishes the already-approved V313 modeled-gap player map only after full-map validation.
