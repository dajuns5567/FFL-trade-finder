...
export default async () => {
  ...
  // Frozen valuation path from V141. Do not alter these formulas from Finder work.
  ...
  // V142 owns only Finder generation/rendering via capture-phase run button handling.
  const runtime = '<script>window.__section1Release="v142";</script><script src="/trade-runtime-v130.js?v=131"></script><script>window.section1V130?.install?.();</script><script src="/trade-ui-canonical-v136.js?v=141"></script><script src="/trade-finder-v142.js?v=142"></script>';
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v142-trade-finder-repair'
    }
  });
};
