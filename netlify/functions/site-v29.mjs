...
export default async () => {
  ...
  // Frozen valuation path from V141. V189 does not alter player/pick valuation formulas.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v189-tier-down-max-value-quality'
    }
  });
};
