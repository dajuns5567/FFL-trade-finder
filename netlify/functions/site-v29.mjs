...
export default async () => {
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v263-selected-positions-add-assets-performance-methodology-v264-value-history-scoring-filters-milestones-v344-theme-v274-nonblocking-consensus-v277-evaluator-roster-v285-specific-max-value-pick-display-v279-specific-tier-up-v282-specific-add-assets-v309-broad-acquire-specific-diversity-specific-max-tier-add-v300-recommended-pick-ownership-v301-specific-player-v309-value-adjustment-v311-modeled-player-values-v319-specific-blank-router-v325'
    }
  });
};
