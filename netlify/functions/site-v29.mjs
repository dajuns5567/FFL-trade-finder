...
export default async () => {
  ...
  // Frozen valuation path from V141. V252 leaves V223/V209 Finder logic and V250 targeted logic unchanged.
  ...
  return new Response(html, {
    ...
    headers: {
      ...
      'x-fll-release': 'section1-v252-add-assets-post-search-backfill'
    }
  });
};
