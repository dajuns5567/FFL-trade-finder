  ...
  const rows={
    ...
    "tess-delaney":[
      ...
      ([
        ...
        "The "+a.mascot+" do not need a new dining room after this "+result+", only better company around the centerpiece. "+star+" brought "+starPts+" points; "+weakName+" brought "+weakPts+". That imbalance follows a "+rec+" team into "+nextName+", where the supporting cast has another chance to stop making the stars host the entire evening.",
