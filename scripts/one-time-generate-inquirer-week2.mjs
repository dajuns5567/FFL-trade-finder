...
function w2SentimentRead(t,prev,r,fs,prevSent,won){
  ...
  const context=won?"A win gives supporters evidence to defend the roster with.":"A loss gives every preseason concern a fresh microphone.";
  const rows={
    "walter-mercer":[
    ...
    "nora-voss":[
      "Rivals can laugh, but the "+a.mascot+" crowd has its own verdict: "+standing+". "+(won?"The win bought optimism another week.":"The loss turned every familiar complaint back into material.")+(hasOld?" The meter moved "+Math.abs(delta)+" points "+direction+" from Week 1.":""),
...
function w2BuildSections(t,prev){
  ...
  const fs=a.fan_sentiment||{},prevSent=prev?.inquirer_article?.fan_sentiment||{},sentiment=[
    ...
    w2S(t,r,"sent-two","The chart below puts that mood on the same -100 to +100 scale as every other fan base, while the Week 1 marker shows whether this week actually changed the room or merely confirmed it.")
  ];
