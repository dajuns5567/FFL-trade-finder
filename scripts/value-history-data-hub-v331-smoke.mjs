...
assert(siteV29.includes('/fleeced-theme-v274.css?v=416'),'production shell must cache-bust the V416 presentation-only Fleeced theme');
assert(siteV29.includes('/fleeced-presentation-v413.js?v=416'),'production shell must load the V416 presentation-only interaction-safe presentation runtime');
assert(siteV29.includes('/trade-select-all-v165.js?v=416'),'production shell must cache-bust the V416 Select All presentation-placement runtime');
