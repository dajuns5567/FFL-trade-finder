...
assert(siteV29.includes('/value-history-v276.js?v=397'),'production shell must cache-bust the current V397 Value History UI/runtime');
assert(siteV29.includes('/ui-player-values-v139.js?v=397'),'production shell must cache-bust the current V397 Player Values UI');
