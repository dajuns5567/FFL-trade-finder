...
assert(siteV29.includes('/fleeced-presentation-v413.js?v=421'),'production shell must load the V416 presentation-only interaction-safe presentation runtime');
