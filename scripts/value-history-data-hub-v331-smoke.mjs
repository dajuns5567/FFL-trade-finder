...
assert(siteV29.includes('/value-history-v276.js?v=405'),'production shell must cache-bust the current V405 Value History UI/runtime');
assert(siteV29.includes('/fleeced-theme-v274.css?v=405'),'production shell must cache-bust the V405 presentation-only Fleeced theme');
