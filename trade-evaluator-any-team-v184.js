...
function install(){ensureControl();if(!document.__evalAnyTeam184){document.__evalAnyTeam184=true;document.addEventListener('click',onClick,true);document.addEventListener('change',onChange,true)}window.__evalAnyTeam179='v184'}
install();
