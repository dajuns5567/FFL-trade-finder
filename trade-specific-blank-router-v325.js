...
function selected(){if(window.tradeSelectAllV165?.aliasActive?.())return[];return[...document.querySelectorAll('#findShop .shopCheck:checked,.shopCheck:checked')].map(x=>x._asset).filter(Boolean)}
