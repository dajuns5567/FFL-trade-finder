...
const MAX=Number(source.MAX)||9999;
...
function apply(a,value){const v=Number(value)||0;if(!isTE(a))return v;const m=multiplier();if(m===1)return v;return Math.min(MAX,round5(v*m))}
...
window.tradeTeScoringAdjustmentV259={MAX,stateRef,scoringSettings,teReceptionBonus,multiplier,isTE,apply,canonicalValue,playerValue,canonicalPackageValue,originalCanonical,originalPackage};
})();
