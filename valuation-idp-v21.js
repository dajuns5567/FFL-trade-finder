...
window.idpPpgQualificationAudit=function(nameOrId){
 ...
 const a=scoringAudit24(id,'idp'),rows=(a.seasons||[]).map(s=>({season:s.season,currentSeason:!!s.currentSeason,points:s.points,games:s.games,ppg:s.ppg,qualifiesSeason:!!s.currentSeason||Number(s.games)>=8,assignedWeight:s.assignedWeight}));
 return{id,name:playerName(id),historicalSeasons:a.historicalSeasons,currentSeasonIncluded:a.currentSeasonIncluded,blendedPpg:a.ppg,seasons:rows};
};
