...
function readyForSnapshot(){
  ...
  if(/loading|updating|refreshing/.test(text))return false;
  return currentRows().length>=100;
}
async function recordSnapshot(){
  try{
    if(!readyForSnapshot()){scheduleSnapshot(15000);return}
