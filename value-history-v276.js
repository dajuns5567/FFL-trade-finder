...
function addStyles(){
  ...
  #valueHistory .vh-compact-side{border:1px solid var(--line);border-radius:10px;padding:8px 10px;background:color-mix(in srgb,var(--card) 72%,#06080c);min-width:0}
