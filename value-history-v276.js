...
function addStyles(){
  ...
  #valueHistory .vh-player-link:hover,#valueHistory .vh-player-link:focus-visible{text-decoration:none!important;color:#e4b53f!important}
  #valueHistory .vh-player-link:hover b,#valueHistory .vh-player-link:focus-visible b{color:#e4b53f!important;text-decoration:underline}
  #valueHistory .vh-player-link:hover small,#valueHistory .vh-player-link:focus-visible small{color:#f2c75d!important}
  #valueHistory .vh-player-name-line{display:flex;align-items:center;gap:6px;min-width:0}
  ...
  #valueHistory .vh-trade-filter-toolbar .vh-trade-reset-wrap{min-width:0;display:grid;grid-template-rows:18px 44px;align-items:end;margin-bottom:6px}\n  #valueHistory .vh-trade-filter-toolbar .vh-trade-reset-spacer{display:block;height:18px;line-height:18px}\n  #valueHistory .vh-trade-filter-toolbar .vh-trade-reset{height:44px;min-height:44px;margin:0;display:flex;align-items:center;justify-content:center}
  ...
  #valueHistory .vh-trade-toggle{display:inline-flex;align-items:center;justify-content:space-between;gap:10px;min-width:170px;font-weight:900;border:1px solid color-mix(in srgb,#e4b53f 42%,var(--line))!important;background:color-mix(in srgb,var(--card) 72%,#06080c)!important;color:#f4f4f5!important;box-shadow:none!important}
  #valueHistory .vh-trade-toggle:hover,#valueHistory .vh-trade-toggle:focus-visible{border-color:#e4b53f!important;background:color-mix(in srgb,var(--card) 72%,#06080c)!important;color:#f2c75d!important;outline:none}
  ...
  #valueHistory .vh-trade-toggle-active{color:#f2c75d!important;background:color-mix(in srgb,var(--card) 72%,#06080c)!important;border-color:color-mix(in srgb,#e4b53f 58%,var(--line))!important;box-shadow:none!important}
  #valueHistory .vh-trade-toggle-active:hover{background:color-mix(in srgb,var(--card) 72%,#06080c)!important;border-color:#e4b53f!important}
  ...
  #valueHistory .vh-trade-side{border:1px solid color-mix(in srgb,#e4b53f 42%,var(--line));border-radius:10px;padding:10px;min-width:0;background:color-mix(in srgb,var(--card) 72%,#06080c)}
  ...
  #valueHistory .vh-trade-assets{display:grid;gap:0;margin:0 0 14px;padding:8px 11px;border:1px solid color-mix(in srgb,#e4b53f 42%,var(--line));border-radius:10px;background:color-mix(in srgb,var(--card) 72%,#06080c)}
  ...
  #valueHistory .vh-original-title,#valueHistory .vh-hindsight-head h4,#valueHistory .vh-history-compare-title{color:#e4b53f!important;font-size:16px!important;font-weight:950!important;letter-spacing:.055em!important;text-transform:uppercase!important;text-shadow:0 0 12px rgba(228,181,63,.08)!important;line-height:1.2!important}
  ...
  #valueHistory .vh-hindsight-head h4{margin:0;text-align:left}
...
function handleContentClick(e){
  const tradeReset=e.target.closest('[data-vh-trade-reset]');
  if(tradeReset){tradeTeamFilter='';tradeYearFilter='';tradeMonthFilter='';renderTradeHistory();return}
