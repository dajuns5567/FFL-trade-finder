...
function addStyles(){
  ...
  #valueHistory .vh-trade-head{display:flex;justify-content:space-between;gap:14px;align-items:flex-start;margin:0 -12px 8px;padding:10px 12px 9px;background:transparent;border-bottom:1px solid color-mix(in srgb,#e4b53f 34%,var(--line))}
